...
const messageUser = async ()=>{
  await addDoc(userCollec,{createdAt: new Date(),name:name,email:email,message:msg})
        ...
        <div className="column">
            <div className="contact-form">
                <form action="#">
                    ...
                    ></textarea>
                    <button type='submit' className='site-btn' onClick={() => { messageUser();}}> Send Message </button>
